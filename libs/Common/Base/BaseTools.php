...
class BaseTools
{
    ...
    protected function zLoadSoapClass()
    {
        ...
        if (isset($this->aProxyConf['proxyIp']) && !empty($this->aProxyConf['proxyIp'])) {
            $this->oSoap->setProxy(
                $this->aProxyConf['proxyIp'],
                $this->aProxyConf['proxyPort'],
                $this->aProxyConf['proxyUser'],
                $this->aProxyConf['proxyPass']
            );
        }
    }
